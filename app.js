// SoundEngine は sound.js に移動
// ユーティリティ(esc, sleep, showToast, doCopy等) は utils.js に移動
// テーマ(THEMES, applyTheme等) は themes.js に移動
// セッションリザルト は result.js に移動
...
// テーマ復元（themes.jsの定数とapp.jsの定数が両方必要）
